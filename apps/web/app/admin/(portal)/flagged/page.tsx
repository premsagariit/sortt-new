            ...
            return (
              ...
              >
                <div className="flex items-start gap-4">
                  {/* Avatar */}
                  <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-red/20 to-red/10 border border-red/20 flex items-center justify-center text-red font-black text-[14px] flex-shrink-0 overflow-hidden">
                    {agg.photo_url ? (
                      <NextImage
                        src={agg.photo_url}
